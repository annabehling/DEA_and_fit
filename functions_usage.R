...
hybrid_mod_allo_f <- hybrid_DE("./all_count_matrices", "allo_f", include_N = TRUE, 
                               parent_1 = "E_elymi", parent_2 = "E_amarillans") #hybrid

exp_file_allo_f <- read_exp_file("./all_count_matrices", "allo_f") #parent
...
classes_df_allo_f <- gene_cats(parent_classes_allo_f, hybrid_classes_allo_f, parent_1 = "E_elymi", parent_2 = "E_amarillans", 
                               results_dir = "./all_count_matrices", species = "allo_f")
...
# reading in read count data
hybrid_mod_hh_f <- hybrid_DE("./all_count_matrices", "HH_f", include_N = TRUE, 
                             parent_1 = "S_paradoxus", parent_2 = "S_cerevisiae") #hybrid

exp_file_hh_f <- read_exp_file("./all_count_matrices", "HH_f") #parent
...
classes_df_hh_f <- gene_cats(parent_classes_hh_f, hybrid_classes_hh_f, parent_1 = "S_paradoxus", parent_2 = "S_cerevisiae", 
                             results_dir = "./all_count_matrices", species = "HH_f")
...
# reading in read count data
hybrid_mod_allo_p <- hybrid_DE("./all_count_matrices", "allo_p", include_N = TRUE, 
                               parent_1 = "G_raimondii", parent_2 = "G_arboreum") #hybrid

exp_file_allo_p <- read_exp_file("./all_count_matrices", "allo_p") #parent
...
classes_df_allo_p <- gene_cats(parent_classes_allo_p, hybrid_classes_allo_p, parent_1 = "G_raimondii", parent_2 = "G_arboreum", 
                               results_dir = "./all_count_matrices", species = "allo_p")
...
# reading in read count data
hybrid_mod_hh_p <- hybrid_DE("./all_count_matrices", "HH_p", include_N = TRUE, 
                             parent_1 = "G_raimondii", parent_2 = "G_arboreum") #hybrid

exp_file_hh_p <- read_exp_file("./all_count_matrices", "HH_p") #parent
...
classes_df_hh_p <- gene_cats(parent_classes_hh_p, hybrid_classes_hh_p, parent_1 = "G_raimondii", parent_2 = "G_arboreum", 
                             results_dir = "./all_count_matrices", species = "HH_p")
...
# reading in read count data
hybrid_mod_allo_a <- hybrid_DE("./all_count_matrices", "allo_a", include_N = TRUE, 
                               parent_1 = "S_pyrenaicus", parent_2 = "S_alburnoides") #hybrid

exp_file_allo_a <- read_exp_file("./all_count_matrices", "allo_a") #parent
...
classes_df_allo_a <- gene_cats(parent_classes_allo_a, hybrid_classes_allo_a, parent_1 = "S_pyrenaicus", parent_2 = "S_alburnoides", 
                               results_dir = "./all_count_matrices", species = "allo_a")
...
# reading in read count data
hybrid_mod_hh_a <- hybrid_DE("./all_count_matrices", "HH_a", include_N = TRUE, 
                             parent_1 = "S_pyrenaicus", parent_2 = "S_alburnoides") #hybrid

exp_file_hh_a <- read_exp_file("./all_count_matrices", "HH_a") #parent
...
classes_df_hh_a <- gene_cats(parent_classes_hh_a, hybrid_classes_hh_a, parent_1 = "S_pyrenaicus", parent_2 = "S_alburnoides", 
                             results_dir = "./all_count_matrices", species = "HH_a")
